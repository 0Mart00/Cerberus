...
class UITheme:
    ...
    MAP_BG_COLOR = LColor(0.02, 0.02, 0.05, 0.98) 
    ...
    # --- HUD színek és méretek ---
    HUD_SHIELD = LColor(0, 0.6, 1, 0.8)    # Világoskék
    HUD_ARMOR = LColor(0.7, 0.7, 0.7, 0.8)   # Szürke
    HUD_HULL = LColor(0.8, 0.2, 0.2, 0.8)    # Piros
    HUD_BG = LColor(0, 0, 0, 0.5)            # Sötét háttér a sávoknak
    BAR_WIDTH = 0.5
    BAR_HEIGHT = 0.035

    # --- Térkép színek ---
    MAP_NODE_CURRENT = LColor(0, 0.8, 0, 1)    
    MAP_NODE_NEIGHBOR = LColor(0, 0.4, 0.8, 1) 
    MAP_NODE_DISTANT = LColor(0.2, 0.2, 0.2, 1)  
