...
class TargetListUI:
    def __init__(self, game):
        ...
        # Mouse Over események a scroll frame-re a húzás blokkolásához
    ...
    def _scroll_frame_enter(self, event):
        ...
        if self.game.local_ship:
            # Ezt a két hívást a Ship.py-ban kell definiálni, feltételezzük, hogy léteznek
    ...
    def _scroll_frame_exit(self, event):
        ...
        # HAJÓ KAMERA ESEMÉNYEK VISSZAÁLLÍTÁSA (ha létezik a hajó)
        if self.game.local_ship:
            # Feltételezzük, hogy a Ship.adjust_zoom a kamera vezérlője
